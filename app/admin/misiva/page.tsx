export default function MisivaPage() {
  return (
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-8">
          <div className="text-center py-12">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 max-w-md mx-auto">
              Esta sección estará disponible próximamente. Aquí podrás gestionar todas las comunicaciones 
              y correspondencia relacionadas con el evento.
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 border border-dashed border-zinc-300 dark:border-zinc-600 rounded-lg">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-500">
                Gestión de mensajes internos del equipo
              </p>
            </div>
            <div className="p-6 border border-dashed border-zinc-300 dark:border-zinc-600 rounded-lg">
              <h3 className="font-semibold text-zinc-700 dark:text-zinc-300 mb-2">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-500">
                Manejo de comunicaciones con participantes
              </p>
            </div>
            <div className="p-6 border border-dashed border-zinc-300 dark:border-zinc-600 rounded-lg">
              <h3 className="font-semibold text-zinc-700 dark:text-zinc-300 mb-2">
